 ...
 */
export declare const DEFAULT_ADDRESS_FILTER = "SENDER_OR_RECEIVER";
/**
 * 1 Trillion. This should be the same as the default value of 'latest' block.
 */
export declare const DEFAULT_BLOCK_END = "0x174876e800";
export declare const DEFAULT_SORTING_PREFERENCE = "desc";
export declare const DEFAULT_PAGE_SIZE = 1000;
export declare const DEFAULT_PAGE_NUMBER = 1;
export declare const DEFAULT_EVENT_SIGNATURE_HASHES: string[];
